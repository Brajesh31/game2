...
export const SubjectDetail: React.FC = () => {
  ...
  useEffect(() => {
    // Load content when class or subject changes
  ...
  return (
    <div className="space-y-8 bg-student-background min-h-screen text-student-text">
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div>
          <h1 className="text-4xl font-bold student-text-gradient">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="student-card p-6 animate-student-slide-up">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-student-text">📚 Books & Chapters</h2>
            </div>
            
            {content.books.length > 0 ? (
              <div className="space-y-4">
                {content.books.map((book: any) => (
                  <div key={book.id} className="p-4 bg-student-background-secondary rounded-lg shadow-student-card hover:shadow-student-hover transition-all duration-200 student-hover-lift">
                    ...
                    <Button 
                      variant="outline" 
                      size="sm" 
                      className="w-full border-student-primary text-student-primary hover:bg-student-primary hover:text-student-on-primary"
                    >
                      Read Book
                    </Button>
                  </div>
              ...
              <div className="text-center py-8">
                <BookOpen className="w-12 h-12 mx-auto text-student-text-muted mb-3" />
          ...
          <div className="student-card p-6 animate-student-slide-up" style={{ animationDelay: '0.1s' }}>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-student-text">🎯 Learning Quests</h2>
            </div>
            
            {content.quests.length > 0 ? (
              <div className="space-y-4">
                {content.quests.map((quest: any) => (
                  <div key={quest.id} className="p-4 bg-student-background-secondary rounded-lg shadow-student-card hover:shadow-student-hover transition-all duration-200 student-hover-lift">
          ...
          <div className="student-card p-6 animate-student-slide-up" style={{ animationDelay: '0.2s' }}>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-student-text">📝 Practice Quizzes</h2>
            </div>
            
            {content.quizzes.length > 0 ? (
              <div className="space-y-4">
                {content.quizzes.map((quiz: any) => (
                  <div key={quiz.id} className="p-4 bg-student-background-secondary rounded-lg shadow-student-card hover:shadow-student-hover transition-all duration-200 student-hover-lift">
                    ...
                    <Button 
                      variant="outline" 
                      size="sm" 
                      className="w-full border-student-accent text-student-accent hover:bg-student-accent hover:text-student-on-primary"
                    >
                      Take Quiz
                    </Button>
                  </div>
              ...
              <div className="text-center py-8">
                <Trophy className="w-12 h-12 mx-auto text-student-text-muted mb-3" />
      ...
      <div className="student-card p-6 bg-gradient-to-r from-student-background-tertiary to-student-background-secondary animate-student-slide-up" style={{ animationDelay: '0.3s' }}>
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-student-primary">{content.books.length}</div>
              <div className="text-student-text-secondary">Available Books</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-student-secondary">{content.quests.length}</div>
              <div className="text-student-text-secondary">Learning Quests</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-student-accent">{content.quizzes.length}</div>
