...
import { Play, Target, Trophy, Zap, BookOpen, FlaskConical } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 min-h-screen bg-student-background text-student-text">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <ResponsiveButton
          onClick={() => navigate('/student/epic-quests')}
          variant="accent"
          size="lg"
          icon={Sword}
          fullWidth
          className="h-20 md:h-24 flex-col space-y-2"
        >
          <span className="text-sm md:text-base font-medium">Epic Quests</span>
        </ResponsiveButton>
        ...
        <ResponsiveButton
          ...
          className="h-20 md:h-24 flex-col space-y-2"
        >
          <span className="text-sm md:text-base font-medium">My Quests</span>
        </ResponsiveButton>
